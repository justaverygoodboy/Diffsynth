...
class WanTrainingModule(DiffusionTrainingModule):
    def __init__(
        ...
        self.pipe = WanVideoPipeline.from_pretrained(torch_dtype=torch.bfloat16, device="cpu", model_configs=model_configs,skip_download=True)
        self.pipe.training_mode = self.training_mode
    ...
    def forward_preprocess(self, data):
        ...
        # 处理联合训练的视频输入
        if self.training_mode == "joint" and "depth_video" in data:
